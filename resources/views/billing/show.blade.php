<x-app-layout>
    ...
    <div class="max-w-3xl space-y-5">
        ...
        <div class="flex flex-wrap items-center justify-between gap-3">
            <a href="{{ route('module.schulkantine.abrechnung.index', ['monat' => $monthValue]) }}"
               class="inline-flex items-center gap-1 text-sm font-medium text-indigo-600 hover:text-indigo-800">
                <x-module-icon name="back" class="text-base" /> zurück zur Abrechnung
            </a>
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-5">
            <div class="flex flex-wrap items-start justify-between gap-4">
                <div>
                    ...
                    <div class="mt-0.5 text-sm text-gray-500">{{ $group?->name ?? 'Ohne Gruppe' }}</div>
                </div>
