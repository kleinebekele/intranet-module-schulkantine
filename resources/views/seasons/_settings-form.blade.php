{{-- Einstellungs-Formular einer Saison. Wird sowohl von der „Neue Saison"-Seite
     (seasons/form) als auch vom Tab „Einstellungen" der Saison-Ansicht genutzt.
     Erwartet: $season, $bundeslaender; optional $settings (nur bei bestehender Saison). --}}
<form method="POST"
