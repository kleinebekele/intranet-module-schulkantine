---
titel: Speiseplan und Wochenfreigabe
route: module.schulkantine.menus.index
...
Freigegeben wird immer eine **ganze Woche**, nicht ein einzelner Tag. Zwei Wege führen dahin:

- **Automatisch**, sobald die Woche innerhalb des eingestellten Vorlaufs liegt (standardmäßig
  zwei Wochen).
...
Die Freigabe ist die grobe Schranke (darf diese Woche überhaupt bestellt werden), die Frist
